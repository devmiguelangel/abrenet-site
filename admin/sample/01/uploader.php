...
$MySql_databasename = 'miki'; //databasename
...
{	
	...
	{
		//allowed file types
		case 'image/png': break; //png file
		case 'image/gif': break; //gif file 
		case 'image/jpeg': break; //jpeg file
		case 'application/pdf': break; //PDF file
		case 'application/msword': break; //ms word file
		case 'application/vnd.ms-excel': break; //ms excel file
		case 'application/x-zip-compressed': break; //zip file
		case 'text/plain': break; //text file
		case 'text/html': break; //html file
		//default:
   ...
   if(move_uploaded_file($_FILES['mFile']["tmp_name"], $UploadDirectory . $NewFileName ))
   {
		...
		die('Success! File Uploaded. => '.$FileType);
