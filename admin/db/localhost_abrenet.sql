...
--
-- Servidor: localhost
-- Tiempo de generación: 15-04-2013 a las 18:58:04
...
--
DROP DATABASE `abrenet_db`;
CREATE DATABASE `abrenet_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `abrenet_db`;
