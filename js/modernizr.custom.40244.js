...
Modernizr.addTest('getusermedia', !!Modernizr.prefixed('getUserMedia', navigator));// async script
// By Theodoor van Donge
Modernizr.addTest('scriptasync', 'async' in document.createElement('script'));// EXIF Orientation test
...
Modernizr.addTest('vibrate', !!Modernizr.prefixed('vibrate', navigator));// by jussi-kalliokoski
...
})(document, window.Modernizr);// Animated PNG
...
Modernizr.addTest('performance', !!Modernizr.prefixed('performance', window));Modernizr.addTest('fullscreen',function(){
